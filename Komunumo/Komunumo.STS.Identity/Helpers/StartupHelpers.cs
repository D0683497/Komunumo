...
using SendGrid;
using Komunumo.STS.Identity.Configuration;
using Komunumo.STS.Identity.Configuration.ApplicationParts;
using Komunumo.STS.Identity.Configuration.Constants;
using Komunumo.STS.Identity.Configuration.Interfaces;
using Komunumo.STS.Identity.Helpers.Localization;
using Komunumo.STS.Identity.Services;
using System.Linq;
using Skoruba.IdentityServer4.Admin.EntityFramework.Interfaces;
using Komunumo.Admin.EntityFramework.MySql.Extensions;
using Komunumo.Admin.EntityFramework.PostgreSQL.Extensions;
using Komunumo.Admin.EntityFramework.Shared.Configuration;
using Komunumo.Admin.EntityFramework.SqlServer.Extensions;
using Skoruba.IdentityServer4.Admin.EntityFramework.Helpers;

namespace Komunumo.STS.Identity.Helpers
{
